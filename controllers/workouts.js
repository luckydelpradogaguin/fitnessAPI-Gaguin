...
module.exports.addWorkout = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        error:
          "Failed to add workout. Please ensure all required fields are provided.",
      });
  }
};
...
module.exports.getMyWorkouts = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Failed to fetch workouts. Please try again later." });
  }
};
...
module.exports.updateWorkout = async (req, res) => {
  try {
    ...
    return res
      .status(400)
      .json({ error: "Failed to update workout. Please check your data." });
  }
};
